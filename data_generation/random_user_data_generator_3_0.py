...
def main():
    ...
    user_df = pd.DataFrame(columns = ["userID", "firstName", "lastName", "username"
                                          "email", "password", "phone", 
                                          "postcode", "ownedSensors"])
    
    # Generate a list of random user ids and add it to the dataframe
    user_id_data = generate_lst(17544, 0, 100000)
    user_df["userID"] = user_id_data
    ...
    user_df["firstName"] = first_name_lst
    ...
    user_df["lastName"] = last_name_lst
    ...
    user_df["ownedSensors"] = owed_sns_lst
